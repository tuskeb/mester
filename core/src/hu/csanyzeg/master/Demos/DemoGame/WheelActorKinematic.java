...
/**
 * Created by tuskeb on 2016. 11. 07..
 */

public class WheelActorKinematic extends WorldActorGroup {
        ...
        public WheelActorKinematic(World world, WorldBodyEditorLoader loader) {
            super(world, loader, "wheel.png", BodyDef.BodyType.KinematicBody, 3, 0.3f,11, false);
        }
